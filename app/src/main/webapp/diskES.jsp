...
<%@page import="com.purplehillsbooks.photegrity.NewsActionLoadDisk"%>
...
<!DOCTYPE HTML>
<HTML>
<HEAD><TITLE>Storing '<%= diskName %>' into Elastic Search</TITLE></HEAD>
<BODY BGCOLOR="#FDF5E6">
<H1>Storing '<%= diskName %>' into Elastic Search</H1>

...
%><%request.setCharacterEncoding("UTF-8");
    ...
    String thisPage = "newsDetail.jsp?"+startPart+"&d="+URLEncoder.encode(dig,"UTF-8");
...
<p><a href="news.jsp?<%=startPart%>">News</a>
   ...
   | <a href="newsDetail.jsp?<%=startPart%>&d=<%=URLEncoder.encode(dig, "UTF-8")%>&sort=num">Sort_by_Number</a>
   | <a href="newsDetail.jsp?<%=startPart%>&d=<%=URLEncoder.encode(dig, "UTF-8")%>&sort=dig">Sort_by_Subject</a></p>
...
<ul>
    ...
    <hr/>
    <input type="hidden" name="go" value="newsDetail.jsp?<%=startPart%>&d=<%=URLEncoder.encode(dig, "UTF-8")%>">
...
<script>
    window.setTimeout(function(){window.location="newsDetail.jsp?<%=startPart%>&d=<%=URLEncoder.encode(dig,"UTF-8")%>&sort=<%=sort%>";},60000);
</script>

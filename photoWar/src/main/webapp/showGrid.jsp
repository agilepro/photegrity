...
%><%
    ...
    Hashtable<String,Object> selectedColumns = gData.getSelectedColumns();
    ...
    Vector<Vector<ImageInfo>> grid = gData.getEntireGrid();

    Vector<String> colVec = gData.getColumnMap();

    Enumeration<Vector<ImageInfo>> e2 = grid.elements();
...
<%
    //do the top info row
    %><tr><td></td><%
    Enumeration<String> cole = colVec.elements();
...
<%!
    ...
    public static int getRowNumberForValueX(int photoValue, Vector<Integer> v)
        throws Exception
    {
        int last = v.size();

...
<%
    if (art!=null)
    {
        ...
        String url = "newsDetail.jsp?f="+URLEncoder.encode(art.getHeaderFrom(), "UTF-8")
...
<ul>
<li> Article No: <%= art.getNumber() %> <a href="newsGaps.jsp?limit=100&pos=<%= art.getNumber() %>">Gaps</a></li>
